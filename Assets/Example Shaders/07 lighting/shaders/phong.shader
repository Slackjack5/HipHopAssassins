    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag (Interpolators i) : SV_Target
            {
                ...
                float3 viewDirection = normalize(viewPosition - i.worldPos);
                ...
                float specularFalloff = max(dot(viewDirection,lightReflectionDirection), 0.0);
                //specularFalloff = pow(specularFalloff, _gloss * MAX_SPECULAR_POWER + 0.00001);
