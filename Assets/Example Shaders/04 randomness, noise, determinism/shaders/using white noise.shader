    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag (Interpolators i) : SV_Target
            {
                ...
                //We are using the lerp function as a type of IF statement. If its greater then 0.5, return -1, else 1
                float spinDir = lerp(-1, 1, step(0.5, wn)); //for Step() , if our value is greater than 0.5 then it will return 1;
                ...
                //the first time we use white noise we are creating an initial offset
                //The second time we are altering the speed of our spin.
