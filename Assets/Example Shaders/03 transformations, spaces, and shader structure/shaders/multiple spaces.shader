        ...
        Pass
        {
            ...
            float4 frag (Interpolators i) : SV_Target
            {
                ...
                for(int i = 0; i < count; i++) {
                    ...
                    //Adding Pow is adding power to our sin, causing it to pause mid way
            
                    // handle translating the uv space
                    float2 translate = float2(0, 0);
                    translate.x += sin(offset * TAU); // translating x by sin of our offset //Tau is 2*PI
                    ...
                    //Standard translation we learned
                    ...
                    float colorOffset = sin(offset * TAU) * 0.1; //Offsetting the color change
