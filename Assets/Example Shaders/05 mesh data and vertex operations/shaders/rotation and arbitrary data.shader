    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Interpolators vert (MeshData v)
            {
                ...
                //float4x4 x = rotation_matrix(float3(1,0,0,_rtox * TAU * o.color.r);
                //float4x4 y = rotation_matrix(float3(0,1,0,_rtoy * TAU * o.color.r);
                //float4x4 z = rotation_matrix(float3(0,0,1,_rtoz * TAU * o.color.r);
                
                //float4x4 rotation = mul(mul(x,y),z);
                //v.vertex = mul(v.vertex, rotation_matrix);
